...
public class AddDrugsDetailsAction extends Action {
	
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response) {
		// TODO Auto-generated method stub
		boolean flag = false;
		DrugsTo drugsTo = (DrugsTo) form;
         
        
		 
		try {
			flag = new UserPersonalDelegate().addDrugsDetails(drugsTo);
			if (flag) {
				request.setAttribute("status",
						UtilConstants._ADD_DRUG_DETAILS);
